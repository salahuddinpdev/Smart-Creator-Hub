  ...
  return (
    <>
      <Seo
        ...
        description="SmartCreatorTools is a free hub of 20+ utilities for creators, students, and developers — built to be fast, private, and bookmarkable."
        canonicalPath="/about"
      />
      <PageWrapper
        title="About SmartCreatorTools"
      ...
      >
        ...
        <p className="flex items-center gap-2">
          Made with <Heart className="inline w-4 h-4 text-rose-500" /> for creators worldwide.
        </p>
      </PageWrapper>
    </>
  );
...
export function Privacy() {
  return (
    <>
      <Seo
        title="Privacy Policy — SmartCreatorTools"
        description="How SmartCreatorTools handles your data: nothing leaves your browser. Our privacy policy in plain English."
...
export function Terms() {
  return (
    <>
      <Seo
        title="Terms of Service — SmartCreatorTools"
        description="Terms of service for using SmartCreatorTools — free online tools for creators, students, and developers."
        canonicalPath="/terms"
      />
      <PageWrapper
...
export function Contact() {
  return (
    <>
      <Seo
        title="Contact — SmartCreatorTools"
        description="Get in touch with the SmartCreatorTools team. Feature requests, bug reports, partnerships, and more."
